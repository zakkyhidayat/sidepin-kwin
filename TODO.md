...
- [ ] Optional config: configurable pinned width ratio (currently hardcoded 40%)
...
- `pinGeometry(entry)` always right-side only: 40% wide, configured height, flush-right, vertically centered
